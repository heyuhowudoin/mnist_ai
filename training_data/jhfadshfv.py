    ...
    for layer in hidden_layers[::-1]:
      for neuron in layer.neurons:
        for weight in neuron.weights:
          ...
          neuron.weights[weight_index] += par_der * -1 * learning_speed
...
#Yes
neurons_per_layer = [1, 4, 6, 4, 1]
network = neural_network(neurons_per_layer)

for i in range(800):
  pygame.draw.rect(window, ((255, 255, 255)), (i, (real_answer((i) / -600) * 400) + 20, 3, 3))
  pygame.display.flip()
...
for i in range(50000):
  ...
  x = random_x * 800
  y = ((network.hidden_layers[-1].neurons[0].value) * 400) + 20

  pygame.draw.rect(window, ((80, 80, 255)), (x, y, 3, 3))

  # print(x, y)
  pygame.display.flip()

  print(real_answer(random_x), network.hidden_layers[-1].neurons[0].value, network.calculate_cost(real_answer(random_x), network.hidden_layers[-1].neurons[0].value), i)